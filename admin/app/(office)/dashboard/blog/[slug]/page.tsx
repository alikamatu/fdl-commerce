        ...
        >
          <div className="flex flex-wrap items-center justify-between gap-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              >
                <ThumbsUp className={`w-5 h-5 ${stats.isLiked ? 'fill-current' : ''}`} />
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-2">
                ...
                >
                  {copySuccess ? <CheckCircle className="w-5 h-5 text-green-600" /> : <Link2 className="w-5 h-5" />}
                </motion.button>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            {comments.length > 0 ? (
              comments.map((comment) => (
                <div key={comment._id} className="bg-white border border-gray-200 rounded-xl p-6">
